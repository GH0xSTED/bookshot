      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">BOOKSHOT</span>
            </div>
            <p className="text-gray-400 text-sm">
              Book professional studio spaces for your creative projects.
              Easy scheduling, seamless experience.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/studios" className="text-gray-400 hover:text-white text-sm">
                  Studios
                </Link>
              </li>
              <li>
                <Link to="/bookings" className="text-gray-400 hover:text-white text-sm">
                  My Bookings
                </Link>
              </li>
              <li>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400 text-sm">
                  123 Studio Way, Creative District, NY 10001
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400 text-sm">info@bookshot.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-400 text-sm text-center">
            &copy; {currentYear} BOOKSHOT. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
